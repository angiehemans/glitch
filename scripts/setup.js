...
if (!fs.existsSync('.env')) {
  ...
  if (fs.existsSync('.env.example')) {
    ...
    console.log('✅ .env file created. Please configure your DATABASE_URL and other environment variables.\n');
  } else {
...
try {
  ...
  try {
    ...
    console.log('⚠️  Database seeding failed (this might be okay if data already exists).\n');
  }
